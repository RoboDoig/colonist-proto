...
public class CraftItemAction : Action
{
    public CraftItemAction(string _description, List<WorldItem> _preconditions, List<WorldItem> _effects, WorldObject _parentObject) 
