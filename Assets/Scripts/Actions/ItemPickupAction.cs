...
public class ItemPickupAction : Action
{
    public ItemPickupAction(string _description, List<WorldItem> _preconditions, List<WorldItem> _effects, WorldObject _parentObject) 
